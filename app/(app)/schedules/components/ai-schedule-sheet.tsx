...
export function AIScheduleSheet({
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      ...
      toast.add({ type: "success", description: "Academic schedule successfully generated by AI!" })
      onSaveSuccess()
      onClose(false)
    } catch (err: any) {
      toast.add({ type: "error", description: err.message || "Failed to process schedule via AI" })
    } finally {
      setAiLoading(false)
    }
  }
      ...
      <SheetContent className="sm:max-w-[440px] font-sans overflow-y-auto">
        ...
        <div className="space-y-6 px-6 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              placeholder="e.g. Only add schedule for Monday and Tuesday..."
              value={aiCommand}
